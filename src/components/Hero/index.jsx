...
const Hero = () => {
    ...
    var settings = {
        ...
        slidesToShow: 1,
        slidesToScroll: 1,
        autoplay: true,  // autoPlay yerine autoplay
        autoplaySpeed: 3000,  // auutoPlaySpeed yerine autoplaySpeed
        cssEase: "ease-in-out",
        pauseOnHover: false,
        pauseOnFocus: true
    };
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2">
                                    ...
                                    <div className="order-1 sm:order-2">
                                        <div
                                            ...
                                            <img src={data.link} className="w-[300px] h-[300px]  sm:h-[450px] sm:w-[450px] sm:scale-125 lg:scale-10 object-contain mx-auto" />
                                        </div>
                                    </div>
                                </div>
                            </div>
